...
HD_PWD='E:/vivado_projects/project_final/project_final.runs/system_cycle_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_cycle_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_cycle_1_0.tcl
