...
HD_PWD='E:/vivado_projects/project_final_testbench/project_final_testbench.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_filter.tcl
