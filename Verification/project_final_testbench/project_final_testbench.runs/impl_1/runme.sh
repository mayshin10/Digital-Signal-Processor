...
HD_PWD='E:/vivado_projects/project_final_testbench/project_final_testbench.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_filter.tcl -notrace
