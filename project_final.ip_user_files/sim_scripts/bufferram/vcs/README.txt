...
#
# Generated by export_simulation on Fri Jun 11 07:51:48 +0900 2021
#
################################################################################
...
'-reset_run' switch to the './bufferram.sh' script.

./bufferram.sh -reset_run
...
./bufferram.sh -noclean_files

For more information on the script, please type './bufferram.sh -help'.
